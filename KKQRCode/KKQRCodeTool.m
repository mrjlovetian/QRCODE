...
#import "KKQRCodeTool.h"
#import <CoreImage/CoreImage.h>
#import <AVFoundation/AVFoundation.h>
#import "RSAUtil.h"
#import "KKQRCodeConst.h"

@implementation KKQRCodeTool
/**
 *  生成一张普通的二维码
 *
...
+ (UIImage *)KKgenerateWithDefaultQRCodeData:(NSDictionary *)dataDic imageViewWidth:(CGFloat)imageViewWidth {
    ...
    // 2、设置数据
    NSString *info = [RSAUtil encryptString:[self dictionaryToJson:dataDic] publicKey:KKRSA_Public_key];//data;
    // 将字符串转换成
    ...
    return [KKQRCodeTool createNonInterpolatedUIImageFormCIImage:outputImage withSize:imageViewWidth];
}
...
+ (UIImage *)KKgenerateWithLogoQRCodeData:(NSDictionary *)dataDic logoImageName:(NSString *)logoImageName logoScaleToSuperView:(CGFloat)logoScaleToSuperView {
    ...
    // 2、设置数据
    NSString *string_data = [RSAUtil encryptString:[self dictionaryToJson:dataDic] publicKey:KKRSA_Public_key];//data;
